...
#define ANALOG0_START_BIT_POSITION      (12)
#define ANALOG1_START_BIT_POSITION      (ANALOG0_START_BIT_POSITION+1)
#define ANALOG2_START_BIT_POSITION      (ANALOG0_START_BIT_POSITION+2)
#define ANALOG3_START_BIT_POSITION      (ANALOG0_START_BIT_POSITION+3)
#define TRISTHIS_NUMBER_DIGITAL_PORTS   (2)
#define TRISTHIS_NUMBER_ANALOG_PORTS    (4)
#define STATUS_READ_ONLY_MASK           ((1<<CONFIGURED_BIT_POSITION)&(1<<V5P0GOOD_BIT_POSITION)&(1<<ANALOG0_START_BIT_POSITION)&(1<<ANALOG1_START_BIT_POSITION)&(1<<ANALOG2_START_BIT_POSITION)&(1<<ANALOG3_START_BIT_POSITION))
