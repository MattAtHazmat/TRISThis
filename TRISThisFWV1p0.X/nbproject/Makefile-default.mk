...
${OBJECTDIR}/source/mainv1p0.o: source/mainv1p0.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${FIXDEPS} "${OBJECTDIR}/source/mainv1p0.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE) -g -D__DEBUG -D__MPLAB_DEBUGGER_REAL_ICE=1 -fframe-base-loclist  -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"include" -I"/opt/microchip/xc32/v1.21/pic32mx/include/peripheral" -O1 -MMD -MF "${OBJECTDIR}/source/mainv1p0.o.d" -o ${OBJECTDIR}/source/mainv1p0.o source/mainv1p0.c   
...
${OBJECTDIR}/source/mainv1p0.o: source/mainv1p0.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/source 
	@${RM} ${OBJECTDIR}/source/mainv1p0.o.d 
	@${FIXDEPS} "${OBJECTDIR}/source/mainv1p0.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"include" -I"/opt/microchip/xc32/v1.21/pic32mx/include/peripheral" -O1 -MMD -MF "${OBJECTDIR}/source/mainv1p0.o.d" -o ${OBJECTDIR}/source/mainv1p0.o source/mainv1p0.c   
...
${OBJECTDIR}/source/I2C_Bus_Master.o: source/I2C_Bus_Master.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/source 
	@${RM} ${OBJECTDIR}/source/I2C_Bus_Master.o.d 
	@${FIXDEPS} "${OBJECTDIR}/source/I2C_Bus_Master.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"include" -I"/opt/microchip/xc32/v1.21/pic32mx/include/peripheral" -O1 -MMD -MF "${OBJECTDIR}/source/I2C_Bus_Master.o.d" -o ${OBJECTDIR}/source/I2C_Bus_Master.o source/I2C_Bus_Master.c   
	
${OBJECTDIR}/source/tick.o: source/tick.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/source 
	@${RM} ${OBJECTDIR}/source/tick.o.d 
	@${FIXDEPS} "${OBJECTDIR}/source/tick.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"include" -I"/opt/microchip/xc32/v1.21/pic32mx/include/peripheral" -O1 -MMD -MF "${OBJECTDIR}/source/tick.o.d" -o ${OBJECTDIR}/source/tick.o source/tick.c   
	
${OBJECTDIR}/source/delay.o: source/delay.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/source 
	@${RM} ${OBJECTDIR}/source/delay.o.d 
	@${FIXDEPS} "${OBJECTDIR}/source/delay.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"include" -I"/opt/microchip/xc32/v1.21/pic32mx/include/peripheral" -O1 -MMD -MF "${OBJECTDIR}/source/delay.o.d" -o ${OBJECTDIR}/source/delay.o source/delay.c   
	
${OBJECTDIR}/source/LED.o: source/LED.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/source 
	@${RM} ${OBJECTDIR}/source/LED.o.d 
	@${FIXDEPS} "${OBJECTDIR}/source/LED.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"include" -I"/opt/microchip/xc32/v1.21/pic32mx/include/peripheral" -O1 -MMD -MF "${OBJECTDIR}/source/LED.o.d" -o ${OBJECTDIR}/source/LED.o source/LED.c   
	
${OBJECTDIR}/source/PAC1710.o: source/PAC1710.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/source 
	@${RM} ${OBJECTDIR}/source/PAC1710.o.d 
	@${FIXDEPS} "${OBJECTDIR}/source/PAC1710.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"include" -I"/opt/microchip/xc32/v1.21/pic32mx/include/peripheral" -O1 -MMD -MF "${OBJECTDIR}/source/PAC1710.o.d" -o ${OBJECTDIR}/source/PAC1710.o source/PAC1710.c   
	
${OBJECTDIR}/source/MCP4461.o: source/MCP4461.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/source 
	@${RM} ${OBJECTDIR}/source/MCP4461.o.d 
	@${FIXDEPS} "${OBJECTDIR}/source/MCP4461.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"include" -I"/opt/microchip/xc32/v1.21/pic32mx/include/peripheral" -O1 -MMD -MF "${OBJECTDIR}/source/MCP4461.o.d" -o ${OBJECTDIR}/source/MCP4461.o source/MCP4461.c   
	
${OBJECTDIR}/source/commsToRPi.o: source/commsToRPi.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} ${OBJECTDIR}/source 
	@${RM} ${OBJECTDIR}/source/commsToRPi.o.d 
	@${FIXDEPS} "${OBJECTDIR}/source/commsToRPi.o.d" $(SILENT) -rsi ${MP_CC_DIR}../  -c ${MP_CC}  $(MP_EXTRA_CC_PRE)  -g -x c -c -mprocessor=$(MP_PROCESSOR_OPTION) -I"include" -I"/opt/microchip/xc32/v1.21/pic32mx/include/peripheral" -O1 -MMD -MF "${OBJECTDIR}/source/commsToRPi.o.d" -o ${OBJECTDIR}/source/commsToRPi.o source/commsToRPi.c   
...
dist/${CND_CONF}/${IMAGE_TYPE}/TRISThisFWV1p0.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	...
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mdebugger -D__MPLAB_DEBUGGER_REAL_ICE=1 -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/TRISThisFWV1p0.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),--defsym=__ICD2RAM=1,--defsym=__MPLAB_DEBUG=1,--defsym=__DEBUG=1,--defsym=__MPLAB_DEBUGGER_REAL_ICE=1,-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map"
